...
describe('TableOfContents', () => {
  it('does not render when isOpen is false', () => {
    const { container } = render(
      <TableOfContents toc={sampleToc} onNavigate={vi.fn()} isOpen={false} onClose={vi.fn()} />
    )
    expect(container.innerHTML).toBe('')
  })

  it('renders TOC items when isOpen is true', () => {
    render(<TableOfContents toc={sampleToc} onNavigate={vi.fn()} isOpen={true} onClose={vi.fn()} />)
  ...
  it('calls onNavigate and onClose when a TOC item is clicked', () => {
    ...
    const onClose = vi.fn()
    render(
      <TableOfContents toc={sampleToc} onNavigate={onNavigate} isOpen={true} onClose={onClose} />
    )
  ...
  it('calls onNavigate with nested item href', () => {
    const onNavigate = vi.fn()
    render(
      <TableOfContents toc={sampleToc} onNavigate={onNavigate} isOpen={true} onClose={vi.fn()} />
    )
  ...
  it('calls onClose when backdrop is clicked', () => {
    const onClose = vi.fn()
    render(<TableOfContents toc={sampleToc} onNavigate={vi.fn()} isOpen={true} onClose={onClose} />)
  ...
  it('renders empty TOC without errors', () => {
    const { container } = render(
      <TableOfContents toc={[]} onNavigate={vi.fn()} isOpen={true} onClose={vi.fn()} />
    )
