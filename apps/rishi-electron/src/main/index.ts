...
app
  ...
  .then(async () => {
    ...
    // React DevTools: see src/renderer/src/main.tsx — we use the standalone
    // GUI (`pnpm exec react-devtools`), not the Chrome extension, because
    // the extension flavour doesn't fully work in modern Electron.
