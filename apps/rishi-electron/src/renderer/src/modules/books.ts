...
export async function updateCoverImage(blob: Blob, id: string): Promise<void> {
...
export async function updateBook(bookSlice: Partial<BookData> & { id: string }): Promise<void> {
