/**
 * Port of `apps/rishi-electron/src/renderer/src/machines/navigationHistory/pageKey.test.ts`.
 *
 * Mirrors electron's behavior exactly so the shared machine is a drop-in
 * replacement (T-P1.6 / NAVHIST-001).
 *
 * Fails today because `./pageKey` does not yet exist.
 */
