export const CONFIG = {
  ...
  APPLE_CONTROLLER_RECLAIM_MS: 5 * 60_000,
  APPLE_EMPTY_ROOM_MS: 2 * 60_000,
  ADMISSION_TICKET_TTL_MS: 10 * 60_000,
  ...
  RATE_LIMITS: {
    ...
    appleSignalingBytesPerUserPerSec: 256 * 1024,
    appleSdpRelaysPerSession: 400,
    speakerRequestCooldownMs: 250,
  },
} as const;
