...
/**
 * Draw a page curl effect on a 2D canvas context.
 *
 * Renders five layers:
 *   1. Flat page with a transparency gradient near the fold line
 *   2. Outer drop shadow
 *   3. Inner curl shadow
 *   4. Curled page flap with a bezier curved edge
 *   5. Fold crease highlight/shadow pair
 */
