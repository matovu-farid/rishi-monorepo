...
export const books = sqliteTable("books", {
    ...
    userId: text("user_id").references(() => user.id), // null on mobile (single-user), set by server during push
...
export const highlights = sqliteTable("highlights", {
    ...
    userId: text("user_id").references(() => user.id), // null on mobile, set by server
...
export const bookWords = sqliteTable("book_words", {
    bookId: text("book_id").notNull(),
    pageNumber: integer("page_number").notNull(),
...
export const bookParagraphs = sqliteTable("book_paragraphs", {
    bookId: text("book_id").notNull(),
    pageNumber: integer("page_number").notNull(),
...
export const appleSubscriptions = sqliteTable("apple_subscriptions", {
    ...
    byOriginalTxn: index("apple_subscriptions_original_txn").on(t.appleOriginalTransactionId),
}));
...
export const devices = sqliteTable("devices", {
    ...
    uniqUserToken: uniqueIndex("devices_user_token_uniq").on(t.userId, t.deviceToken),
}));
