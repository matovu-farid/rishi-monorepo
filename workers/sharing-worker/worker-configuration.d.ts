/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: b92f51b25410f8bfa2c48485f2e60487)
// Runtime types generated with workerd@1.20260911.1 2026-05-30 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	AUTH_BASE_URL: "https://api.fidexa.org";
	SESSION_ROOM: DurableObjectNamespace<import("./src/index").SessionRoom>;
	APPLE_SESSION_ROOM: DurableObjectNamespace<import("./src/index").AppleSessionRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionRoom" | "AppleSessionRoom";
	}
