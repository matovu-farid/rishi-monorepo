...
import { indexBookProgram, chunkId } from './index-program'
...
describe('chunkId', () => {
  it('matches the legacy formula pageNumber * 1_000_000 + bookId * 10_000 + index', () => {
    expect(chunkId(1, 7, 0)).toBe(1 * 1_000_000 + 7 * 10_000 + 0)
    expect(chunkId(1, 7, 1)).toBe(1 * 1_000_000 + 7 * 10_000 + 1)
    expect(chunkId(2, 7, 0)).toBe(2 * 1_000_000 + 7 * 10_000 + 0)
    expect(chunkId(10, 3, 5)).toBe(10 * 1_000_000 + 3 * 10_000 + 5)
  })
})
