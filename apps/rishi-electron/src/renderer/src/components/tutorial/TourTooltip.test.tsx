...
describe('TourTooltip', () => {
  ...
  it('renders step title and description', () => {
    render(
      <TourTooltip step={mockStep} stepIndex={0} totalSteps={4} onNext={vi.fn()} onSkip={vi.fn()} />
    )
  ...
  it('displays correct step counter', () => {
    render(
      <TourTooltip step={mockStep} stepIndex={1} totalSteps={4} onNext={vi.fn()} onSkip={vi.fn()} />
    )
  ...
  it("shows 'Done' on last step instead of 'Next'", () => {
    render(
      <TourTooltip step={mockStep} stepIndex={3} totalSteps={4} onNext={vi.fn()} onSkip={vi.fn()} />
    )
  ...
  it('calls onNext when Next/Done is clicked', () => {
    const onNext = vi.fn()
    render(
      <TourTooltip step={mockStep} stepIndex={0} totalSteps={4} onNext={onNext} onSkip={vi.fn()} />
    )
  ...
  it('calls onSkip when Skip is clicked', () => {
    const onSkip = vi.fn()
    render(
      <TourTooltip step={mockStep} stepIndex={0} totalSteps={4} onNext={vi.fn()} onSkip={onSkip} />
    )
