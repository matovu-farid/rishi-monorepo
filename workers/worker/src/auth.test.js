...
import { createAuth, deriveHasPro } from "./auth";
async function generateAppleSigningKey() {
...
async function mintAppleIdToken(opts) {
    ...
    if (opts.nonceClaim !== undefined)
        claims.nonce = opts.nonceClaim;
...
function stubAppleJWKS(fixture) {
...
async function makeEnv(_fixture, overrides = {}) {
