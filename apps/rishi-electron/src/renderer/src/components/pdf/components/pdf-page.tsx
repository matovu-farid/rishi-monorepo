...
export function PageComponent({
  ...
  function isInsideParagraph(wordTransform: Transform) {
    ...
    const isBelowOrEqualTop = wordTransform[5] <= highlightedParagraph.dimensions.top
    const isAboveOrEqualBottom = wordTransform[5] >= highlightedParagraph.dimensions.bottom
