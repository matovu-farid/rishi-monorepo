/**
 * Tagged TTS errors. Ported verbatim from
 * `apps/rishi-electron/src/renderer/src/services/tts/errors.ts`.
 *
 * Uses `effect.Data.TaggedError` (optional peer dependency).
 */
