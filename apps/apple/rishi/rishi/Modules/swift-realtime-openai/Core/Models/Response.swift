public struct Response: Identifiable, Equatable, Hashable, Codable, Sendable {
	public struct Config: Equatable, Hashable, Codable, Sendable {
		...
		public let modalities: [RealtimeSession.Modality]

		/// Instructions for the model.
		public let instructions: String

		/// The voice the model uses to respond.
		public let voice: RealtimeSession.Voice

		/// The format of output audio.
		public let outputAudioFormat: RealtimeSession.AudioFormat
		...
		public init(modalities: [RealtimeSession.Modality], instructions: String, voice: RealtimeSession.Voice, outputAudioFormat: RealtimeSession.AudioFormat, tools: [Tool], toolChoice: Tool.Choice, temperature: Double, maxResponseOutputTokens: Int?, conversation: Conversation?, metadata: [String: String]?, input: [Item]?) {
	...
	public struct Usage: Equatable, Hashable, Codable, Sendable {
		...
		// Rishi fork patch: the realtime transcription `usage`
		// (conversation.item.input_audio_transcription.completed) omits
		// cachedTokens / cachedTokensDetails / outputTokenDetails that the
		// response `usage` includes. Make the whole detail tree optional so
		// either shape decodes without throwing keyNotFound.
