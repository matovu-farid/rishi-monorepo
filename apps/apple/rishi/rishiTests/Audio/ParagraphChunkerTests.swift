...
//
//  Test execution is gated by the orchestrator-owned end-of-phase
//  `xcodebuild rishi` integrated build (subagents must not invoke xcodebuild
//  per apps/apple/CLAUDE.md).
//
