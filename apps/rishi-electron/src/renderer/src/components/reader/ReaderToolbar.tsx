...
export function ReaderToolbar({ children, leftContent, panelsOpen = false }: ReaderToolbarProps) {
  ...
  return (
    <div
      ...
      style={{ ...style, pointerEvents: 'none', WebkitAppRegion: 'drag' } as React.CSSProperties}
    >
      <div
