...
/// `AppResourceBundle.bundle`. The model's output (`var_570`) is a 384-dim
...
public final class CoreMLMiniLMEmbedder: BookEmbedder, @unchecked Sendable {
    ...
    public init() throws {
        ...
        let compiled = AppResourceBundle.bundle.url(forResource: "AllMiniLML6V2", withExtension: "mlmodelc")
        let raw = AppResourceBundle.bundle.url(forResource: "AllMiniLML6V2", withExtension: "mlmodel")
