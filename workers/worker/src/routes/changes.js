...
function toSecondsSinceRefDate(msEpoch) {
...
changesRoutes.get("/", requireAuth, async (c) => {
    ...
    for (const row of bookRows) {
        ...
        const { filePath: _fp, coverPath: _cp, id, updatedAt, isDeleted, ...rest } = row;
        void _fp;
        void _cp;
        changes.push({
            kind: "book",
    ...
    for (const row of bookmarkRows) {
        ...
        const createdAtIso = typeof createdAtMs === "number"
