/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 56466749a5022fa570248acd1878c201)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_API_URL" | "PUBLIC_WEB_URL" | "BOOK_MAX_FILE_BYTES" | "BOOK_MAX_PER_USER" | "BOOK_MAX_USER_BYTES" | "ACCESS_TOKEN_SECRET" | "APPLE_APNS_KEY_ID" | "APPLE_APNS_KEY_P8" | "APPLE_IDENTITY_RETENTION_SECRET_CURRENT" | "APPLE_SIWA_CLIENT_ID" | "APPLE_SIWA_KEY_ID" | "APPLE_SIWA_PRIVATE_KEY" | "APPLE_TEAM_ID" | "APPLE_TRANSACTION_HASH_SECRET" | "BETTER_AUTH_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "DEEPGRAM_KEY" | "ELEVEN_LABS_API_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "JWT_PRIVATE_KEY" | "OPENAI_API_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "REFRESH_TOKEN_SECRET" | "RESEND_API_KEY" | "SIWA_TOKEN_ENCRYPTION_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "UPSTASH_REDIS_REST_TOKEN" | "UPSTASH_REDIS_REST_URL" | "VOICE_SESSION_NONCE_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
