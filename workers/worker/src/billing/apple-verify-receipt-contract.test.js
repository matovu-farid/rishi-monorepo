 ...
 * private copy.
 */
const fixturesDir = resolve(__dirname, "../../../../apps/apple/Packages/RishiAPI/Tests/RishiAPITests/Fixtures");
describe("apple-verify-receipt contract — response shape", () => {
    const fixture = JSON.parse(readFileSync(resolve(fixturesDir, "verify-receipt-response.json"), "utf-8"));
...
describe("apple-verify-receipt contract — request shape", () => {
    const fixture = JSON.parse(readFileSync(resolve(fixturesDir, "verify-receipt-request.json"), "utf-8"));
