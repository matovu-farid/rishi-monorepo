/**
 * TTS disk cache. Ported verbatim from
 * `apps/rishi-electron/src/renderer/src/services/tts/cache.ts`.
 *
 * Platform-agnostic: backed by the `TtsIpcChannels` port, which is
 * implemented per-platform (electron IPC on desktop, expo-file-system
 * on mobile).
 */
import md5 from 'md5'
