...
export function mergeShortParagraphs(paragraphs: string[], minLength: number): string[] {
...
/** MAIN HELPER */
export function wordsToFinalParagraphs(words: string[], options: Options = {}): string[] {
  const {
