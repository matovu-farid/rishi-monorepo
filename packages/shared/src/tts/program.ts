/**
 * Effect-based TTS request program. Ported verbatim from
 * `apps/rishi-electron/src/renderer/src/services/tts/program.ts`.
 *
 * Manages a priority queue (hi/lo) with bounded concurrency, exponential
 * backoff retry, request dedup, cancellation, and fire-and-forget cache
 * writes + LRU eviction.
 */
...
export interface Program {
  ...
  /** Stop the worker fiber. Used by tests for clean teardown. */
