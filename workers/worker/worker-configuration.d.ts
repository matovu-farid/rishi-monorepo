/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 45a42072f4ef97f95526a7d3f692327e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOOK_MAX_FILE_BYTES" | "BOOK_MAX_PER_USER" | "BOOK_MAX_USER_BYTES" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "PUBLIC_API_URL" | "PUBLIC_WEB_URL" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ENABLE_TEST_AUTH" | "TEST_AUTH_SECRET" | "JWT_PRIVATE_KEY" | "REFRESH_TOKEN_SECRET" | "ACCESS_TOKEN_SECRET" | "ELEVEN_LABS_API_KEY" | "OPENAI_API_KEY" | "DEEPGRAM_KEY" | "VOICE_SESSION_NONCE_SECRET" | "ENABLE_OPS_ADMIN" | "OPS_ADMIN_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
